...
public class QLProductFrame extends javax.swing.JFrame {
    ...
    private IProduct_Service iProduct_Service = new Product_Service();
    private ArrayList<Product> listProducts = iProduct_Service.Select();

    public QLProductFrame() {
        initComponents();
        iProduct_Service.Insert(new Product("Lam", 281103));
        iProduct_Service.Insert(new Product("Huyen", 210803));
        loadTable();
    }
    ...
    public void loadTable() {
        ...
        for (Product listProduct : listProducts) {
            dtm.addRow(new Object[]{
                listProduct.getName(), listProduct.getPrice()
            });
        }
    }
    ...
    private void tblTBMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblTBMouseClicked
        ...
        txtName.setText(tblTB.getValueAt(row, 0).toString());
